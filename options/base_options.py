...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default='res50',
            help='architecture for binary classification',
        )
        ...
        parser.add_argument(
            '--textroot',
            default='./Genimage_CNNDetection_CLIP_prefix_caption/',
            help='path to texts',
        )
        ...
        parser.add_argument(
            '--classes',
            default='',
            help='which classes to use, separated by comma. If empty, use all subfolders of dataroot',
        )
        ...
        parser.add_argument(
            '--loadSize', type=int, default=256, help='scale images to this size'
        )
        parser.add_argument(
            '--cropSize', type=int, default=224, help='then crop to this size'
        )
        parser.add_argument(
            '--gpu_ids',
            type=str,
        ...
        parser.add_argument(
            '--num_threads', type=int, default=8, help='# threads for loading data'
        )
        parser.add_argument(
            '--checkpoints_dir',
            type=str,
        ...
        parser.add_argument(
            '--delr_freq', type=int, default=20, help='frequency of change lr'
        )
        parser.add_argument('--delr', type=float, default=0.8, help='delr')
        parser.add_argument('--seed', type=int, default=123, help='seed')
        parser.add_argument(
            '--clip', type=str, default='./clip-vit-large-patch14/', help='clip path'
        )
        parser.add_argument(
            '--claloss', type=float, default=0.5, help='fixed num layer'
        )
        ...
        parser.add_argument(
            '--lora_dropout', type=float, default=0.1, help='eval frequency'
        )
        parser.add_argument(
    ...
    def parse(self, print_options=True):
        ...
        opt.name = '__'.join(
            [
                ...
                'claloss_' + str(opt.claloss),
                'lora_r_' + str(opt.lora_r),
                'lora_alpha_' + str(opt.lora_alpha),
                'lora_dropout_' + str(opt.lora_dropout),
                'lr_' + str(opt.lr),
            ]
        )
